...
├── references/
│   ├── geo-framework.md              # Математика PAWC, KDD 2024, AutoGEO, матрица движков
...
│   ├── ai-crawler-spec.md            # Защита RFC 9309 от утечек и стандарт llms.txt
│   └── content-strategy-ai.md        # Принцип Information Gain, front-loading, сбор доказательств
└── evals/
    └── evals.json                    # Детерминированные тесты + негативные проверки безопасности
```
