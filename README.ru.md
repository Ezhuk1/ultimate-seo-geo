...
Встроенный детерминированный движок не требует **никаких сторонних pip-зависимостей** (написан на стандартной библиотеке Python 3.10+) и отрабатывает быстрее **50 мс**:
